object Versions {
    ...
    const val androidxFragment = "1.3.0-alpha05"
    const val androidxLifecycle = "2.3.0-alpha03"
    const val androidxPreference = "1.1.1"
    const val androidxRecyclerView = "1.2.0-alpha03"
...
object Dep {
    ...
    const val hyperionMeasure = "com.willowtreeapps.hyperion:hyperion-measurement:${Versions.hyperion}"
    const val hyperionSharedPref = "com.willowtreeapps.hyperion:hyperion-shared-preferences:${Versions.hyperion}"
