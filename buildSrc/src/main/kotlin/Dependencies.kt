object Versions {
    const val aboutLibraries = "8.6.2"
    const val androidGradlePlugin = "7.0.0-alpha02"
    const val androidxActivity = "1.2.0-beta02"
    ...
    const val coilAccompanist = "0.4.0"
    ...
    const val robolectric = "4.5-alpha-2"
