object Versions {
    ...
    const val androidxActivity = "1.3.0-alpha05"
    const val androidxAppCompat = "1.3.0-rc01"
    const val androidxBrowser = "1.3.0"
    const val androidxConstraintLayout = "2.1.0-beta01"
    const val androidxCore = "1.6.0-alpha01"
    const val androidxFragment = "1.3.2"
    const val androidxHilt = "1.0.0-beta01"
    const val androidxHiltViewModel = "1.0.0-alpha03"
    const val androidxLifecycle = "2.4.0-alpha01"
    const val androidxLifecycleViewModelCompose = "1.0.0-alpha03"
    const val androidxPreference = "1.1.1"
    const val androidxRecyclerView = "1.2.0-rc01"
    ...
    const val androidxWork = "2.7.0-alpha02"
    const val apacheCommonsText = "1.9"
    const val barista = "3.8.0"
    ...
    const val firebaseCrashlyticsGradlePlugin = "2.5.1"
    const val flowSharedPreferences = "1.4.0"
...
object Dep {
    ...
    const val androidxHiltViewModel = "androidx.hilt:hilt-lifecycle-viewmodel:${Versions.androidxHiltViewModel}"
    ...
    const val androidxViewModelCompose = "androidx.lifecycle:lifecycle-viewmodel-compose:${Versions.androidxLifecycleViewModelCompose}"
    ...
    const val coilAccompanist = "com.google.accompanist:accompanist-coil:${Versions.coilAccompanist}"
    ...
    const val flowSharedPreferences = "com.github.tfcporciuncula.flow-preferences:flow-preferences:${Versions.flowSharedPreferences}"
