...
class BadgeHolder(
    container: ViewGroup
) : DynamicViewBindingHolder<BadgeItem, TimelineHolderBinding>(container, TimelineHolderBinding::inflate) {
    override fun TimelineHolderBinding.bind(item: BadgeItem) {
