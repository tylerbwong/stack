...
class RevisionHolder(
    container: ViewGroup
) : DynamicViewBindingHolder<RevisionItem, TimelineHolderBinding>(container, TimelineHolderBinding::inflate) {
    override fun TimelineHolderBinding.bind(item: RevisionItem) {
