...
class CommentedHolder(
    container: ViewGroup
) : DynamicViewBindingHolder<CommentedItem, TimelineHolderBinding>(container, TimelineHolderBinding::inflate) {
    override fun TimelineHolderBinding.bind(item: CommentedItem) {
