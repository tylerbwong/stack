...
class AcceptedHolder(
    container: ViewGroup
) : DynamicViewBindingHolder<AcceptedItem, TimelineHolderBinding>(container, TimelineHolderBinding::inflate) {
    override fun TimelineHolderBinding.bind(item: AcceptedItem) {
