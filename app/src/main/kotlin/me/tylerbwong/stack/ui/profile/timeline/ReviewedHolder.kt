...
class ReviewedHolder(
    container: ViewGroup
) : DynamicViewBindingHolder<ReviewedItem, TimelineHolderBinding>(container, TimelineHolderBinding::inflate) {
    override fun TimelineHolderBinding.bind(item: ReviewedItem) {
