...
class MigrationModule {
    ...
    fun provideAnswerCommentCountColumnMigration(): Migration = object : Migration(8, 9) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL("ALTER TABLE answer ADD COLUMN commentCount INTEGER")
        }
    }
    ...
    fun provideSiteRegisteredUserMigration(): Migration = object : Migration(9, 10) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL("ALTER TABLE site ADD COLUMN isUserRegistered INTEGER NOT NULL default 0")
        }
    }
    ...
    fun provideAnswerShareLinkMigration(): Migration = object : Migration(10, 11) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL("ALTER TABLE answer ADD COLUMN shareLink TEXT NOT NULL default ''")
        }
    }
    ...
    fun provideQuestionDraftDetailsMigration(): Migration = object : Migration(11, 12) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL("ALTER TABLE question_drafts ADD COLUMN expand_body TEXT NOT NULL default ''")
        }
    }
    ...
    fun provideCommentDraftsMigration(): Migration = object : Migration(12, 13) {
        override fun migrate(db: SupportSQLiteDatabase) {
            db.execSQL("CREATE TABLE IF NOT EXISTS comment_drafts (`post_id` INTEGER NOT " +
